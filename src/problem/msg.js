import {PB_BT_ADD_PBS, PB_BT_ADD_PBD, PB_BT_ADD_PBM, PB_BT_HELP, PB_BT_VALID, PB_BT_RESULT, PB_FEEDBACK,
 PB_INTRO, PB_TITRE, PB_PLACEHOLDER, PB_NUMBER, PB_LABEL_REPONSE} from "./lang_fr.js"
...
const PB_REPONSE = function( unite ) {
  let html = "<form id = 'pb_problem' class='form-inline' action='#'><div class = 'form-group'>"
...
const PB_ENONCE = function( id, niveau, context, question, img, mmol ) {
  let html_img = ''
  if ( img != 'Null' ) {
    html_img = "<img id='pb_img' width = '100%' style='max-height:300px' class='image-fluid rounded' src = 'src/resources/img/" + img + "'/>"
  }
...
export  {PB_ENONCE, PB_REPONSE, PB_INIT, PB_ALERT_SUCCESS, PB_ALERT_ERROR }